...
-   Comments on the enum values should start with \"///\<\" to enable
...
### More on Doxygen and JavaDoc {#more_on_doxygen_and_javadoc}
...
Further explanations, general bitching, etc. don\'t go into the first
