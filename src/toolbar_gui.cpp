...
struct MainToolbarWindow : Window {
	...
	void OnPaint() override
	{
		...
		this->SetWidgetDisabledState(WID_TN_ROADS, GetCompanyRoadtypes(_local_company, ROADTYPE_ROAD) == ROADSUBTYPES_NONE);
...
void AllocateToolbar()
{
	...
	_last_built_tramtype_identifier = RoadTypeIdentifier(ROADTYPE_TRAM, ROADSUBTYPE_NORMAL);
